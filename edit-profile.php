                                                                                                                                        ...
                                                                                                                                        if(isset($_POST['update_profile'])){
                                                                                                                                            ...
                                                                                                                                            if($file != "")
                                                                                                                                            {
                                                                                                                                                if($extension!= "svg" ) {
                                                                                                                                                    ...
                                                                                                                                                    $error[] = 'Sorry, only svg files are allowed';
                                                                                                                                                }
                                                                                                                                            }
                                                                                                                                            ...
                                                                                                                                            if(!isset($error)){
                                                                                                                                                ...
                                                                                                                                                $result = mysqli_query($dbc,"UPDATE users SET fname='$fname',lname='$lname',username='$username', age='$age', dob='$dob' WHERE email='$email'");
                                                                                                                                                if($result)
                                                                                                                                                {
                        ...
                        <form method="post" enctype='multipart/form-data' action="">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <center>
                                        <?php if($image==NULL)
                                              {
                                                  echo '<img src="src="Image/logo.svg"">';
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="text" name="d" value="<?php echo $dob;?>" class="form-control" />
                                    </div>
                                </div>
                            </div>
