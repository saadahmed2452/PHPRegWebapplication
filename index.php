        ...
        <div class="row">
            ...
            if(isset($_POST['signup'])){
                ...
                if(!isset($error)){
                    ...
                    $result = mysqli_query($dbc,"INSERT into users(fname,lname,username,email,password) values('$fname','$lname','$username','$email','$password')");
                   
                    $sql="INSERT into users(fname,lname,username,email,password) VALUES (?,?,?,?,?)";
                    $stmti = $mysqli->prepare($sql);
                    $stmti->bind_param('ssis',$fname,$lname,$username,$email,$password);
                    $stmti->execute();
                    $stmti->close();
            ...
            <div class="col-sm-4">
                ...
                <div class="successmsg">
                    <span style="font-size:100px;">&#9989;</span><br /> You have registered successfully . <br /><a href="login.php" style="color:#fff;">Login here... </a>
                </div>
                <?php } else { ?>
